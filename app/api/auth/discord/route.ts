...
const DISCORD_REDIRECT_URI = normalizedAppUrl
  ? `${normalizedAppUrl}/api/auth/discord/callback`
...
export async function GET(request: NextRequest) {
  ...
  console.log("[v0] Raw APP_URL:", APP_URL)
  console.log("[v0] Normalized APP_URL:", normalizedAppUrl)
  console.log("[v0] Final Redirect URI:", DISCORD_REDIRECT_URI)
  ...
  console.log("[v0] Full Discord auth URL:", authUrl.toString())
